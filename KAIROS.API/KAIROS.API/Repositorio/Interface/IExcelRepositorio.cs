...
namespace KAIROS.API.Repositorio.Interface
{
    public interface IExcelRepositorio
    {
        ...
        Task<List<Cargo>> ListaCargosNovo(string CaminhoExcel);        
        Task<List<Estrutura>> ListaEstruturas(string CaminhoExcel);
        Task<List<Estrutura>> ListaEstruturasNovo(string CaminhoExcel);
        Task<List<Horarios>> ListaHorarios(string CaminhoExcel);
        Task<List<Horarios>> ListaHorariosNovo(string CaminhoExcel);
