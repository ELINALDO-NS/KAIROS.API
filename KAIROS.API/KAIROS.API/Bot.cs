...
namespace KAIROS.API
{
    public class Bot
    {
        ...
        public void InsereSaldo(ChromeDriver bot , List<SaldoBH> saldoBHs,string Historico) 
        {
            using (bot)
            {
                Thread.Sleep(10000);
                ...
                //        bot.ExecuteScript($"document.getElementById('dataLancarBancoHoras').value = '{saldo.Data}'");
